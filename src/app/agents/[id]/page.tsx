...
import { Loader2, Star, Phone, Mail, CheckCircle2 } from "lucide-react";
              ...
              <div className="w-full md:w-3/5 p-8 md:p-12 flex flex-col justify-center">
                ...
                <div className="flex py-4 gap-6 mb-6 border-y border-border">
                  <div className="flex flex-col">
                    <span className="text-muted-foreground text-sm uppercase font-bold tracking-wider mb-1">
                      Experience
                    </span>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <Button
                    variant="outline"
                    className="h-14 border-border hover:border-luxury-gold hover:text-luxury-gold hover:bg-luxury-gold/5 rounded-xl px-6"
                  >
