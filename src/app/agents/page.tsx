      ...
      <div className="bg-luxury-emerald pt-32 pb-16 px-4 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center justify-center p-3 bg-white/10 rounded-full mb-6 max-w-fit mx-auto backdrop-blur-md">
             ...
             <span className="text-white font-bold tracking-wide uppercase text-sm">Award-Winning Team</span>
          </div>
          ...
          <p className="text-white/80 max-w-2xl mx-auto text-lg mb-10">
            Our premier real estate advisors bring decades of experience and exclusive market access to help you find your perfect luxury property.
          </p>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-20">
            ...
            >
              ...
              <div className="relative inline-flex items-center justify-center w-24 h-24 rounded-full bg-gradient-to-br from-luxury-emerald/20 to-luxury-emerald/10 border-2 border-luxury-emerald/30 mb-8">
              ...
              <div className="mt-12 p-6 bg-muted/30 rounded-2xl border border-border/50">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Our real estate experts are here to help you find the perfect property. 
                  Reach out to our support team for personalized recommendations or to be notified when new agents join our platform.
                </p>
              </div>
            </motion.div>
          </div>
